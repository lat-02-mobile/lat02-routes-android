...
object FakeTourPointData {
    ...
    private val tourPoint1 = TourPointPath("1", "1", "City 1", "13 street", location1, "", "", tourPointCategory1, "Hospital")
    private val location2 = coordinatesToLocation(-16.524285569842718, -68.12298370418992)
    private val tourPoint2 = TourPointPath("1", "2", "City 2", "14 street", location2, "", "", tourPointCategory2, "Airport")
    val tourPoints = listOf(tourPoint1, tourPoint2)
    private val locationLocal = Location(-16.52035351419114, -68.12580890707301)
    private val tourPointEntity = TourPointEntity("1", "1", "City 1", "13 street", locationLocal, "http", "park", "1", "1", 1666618377352, 1666618377352)
