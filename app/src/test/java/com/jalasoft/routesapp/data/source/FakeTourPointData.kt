...
object FakeTourPointData {
    ...
    private val tourPoint1 = TourPointPath("1", "City 1", "13 street", location1, "", null, "Museum")
    private val location2 = coordinatesToLocation(-16.524285569842718, -68.12298370418992)
    private val tourPoint2 = TourPointPath("2", "City 2", "14 street", location2, "", null, "Park")
    val tourPoints = listOf(tourPoint1, tourPoint2)
    private val locationLocal = Location(-16.52035351419114, -68.12580890707301)
    private val tourPointEntity = TourPointEntity("1", "City 1", "13 street", locationLocal, "http", "park", "1")
