...
constructor(private val repository: RouteRepository, private val gDirectionsRepository: DirectionsRepository) : ViewModel() {
    ...
    fun getPossibleRoutes() = viewModelScope.launch {
        ...
        val line1 = LineRoutePath("Line 1", "Bus", null, "Bus", "1", points1, start1, end1, stops1, lineCategoryIcons1, "#67F5ED", 3.0)
        ...
        val line2 = LineRoutePath("246", "Mini", null, "Mini", "2", points2, start2, end2, stops2, lineCategoryIcons2, "#6495ED", 3.2)
        ...
        val line3 = LineRoutePath("LA", "Metro", null, "Metro", "3", points3, start3, end3, stops3, lineCategoryIcons3, "#533483", 3.4)
