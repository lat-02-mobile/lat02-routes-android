...
object LocationHelper {
    ...
    fun getOneRouteLine(line: LineRoutePath, nearestStopToDestination: Location, nearestStopToOrigin: Location): AvailableTransport? {
        ...
        if (indexOrigin < indexDestination) {
            ...
            val newLine = LineRoutePath(line.idLine, line.lineName, line.category, line.routeName, newRoutePoints, line.start, line.end, newStops, line.blackIcon, line.whiteIcon, line.color, line.averageVelocity)
    ...
    fun getSubLine(line: LineRoutePath, nearestStop: Location, sliceFromStart: Boolean): LineRoutePath {
        ...
        return if (sliceFromStart) {
            ...
            LineRoutePath(line.idLine, line.lineName, line.category, line.routeName, newRoutePoints, line.start, line.end, newStops, line.blackIcon, line.whiteIcon, line.color, line.averageVelocity)
        } else {
